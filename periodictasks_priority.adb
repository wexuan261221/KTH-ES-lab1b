...
with System; use System; --new add
...
procedure PeriodicTasks_Priority is
   ...
   Task_1 : T(1, 20, Warm_Up_Time, 2000, 1000, 2000);  -- low
   Task_2 : T(2, 22, Warm_Up_Time, 1000,  500,  1000);
   Task_3 : T(3, 24, Warm_Up_Time, 800,  200,  800);
   Task_4 : T(4, 25, Warm_Up_Time, 700,  500,  700);
   Task_5 : T(5, 28, Warm_Up_Time, 500,  200,  500);
   Task_6 : T(6, 30, Warm_Up_Time, 400,  100,  400);  -- high
